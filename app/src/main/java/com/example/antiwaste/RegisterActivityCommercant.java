...
public class RegisterActivityCommercant extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_commercant);
    ...
    public void onClickConnexion(View view) {
        startActivity(new Intent(this,LoginActivityCommercant.class));
    ...
    public void registration(Map<String, String>parameters){
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(RegisterActivityCommercant.this);
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            if (response.getLong("id_utilisateur")==0){
                                Toast.makeText(RegisterActivityCommercant.this, "un compte existe déjà avec cette adresse!", Toast.LENGTH_LONG).show();


                            }else{
                                Toast.makeText(RegisterActivityCommercant.this, "Bravo! vous venez de vous inscrire", Toast.LENGTH_LONG).show();
                                startActivity(new Intent(RegisterActivityCommercant.this,LoginActivity.class));
                                overridePendingTransition(R.anim.slide_in_left,R.anim.stay);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(RegisterActivityCommercant.this, "Some error occurred -> "+error.toString(), Toast.LENGTH_LONG).show();
                    }
                }
        );
